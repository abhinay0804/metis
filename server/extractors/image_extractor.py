...
import cv2
import numpy as np
from server.detectors.logo_redactor import LogoRedactor
import pytesseract
...
class ImageExtractor:
    ...
    def __init__(self, enable_logo_redaction: bool = True, templates_dir: str = "templates/logos", enable_ocr: bool = True, yolo_model_path: str = None):
        self.enable_logo_redaction = enable_logo_redaction
        self.logo_redactor = LogoRedactor(templates_dir=templates_dir, yolo_model_path=yolo_model_path) if enable_logo_redaction else None
