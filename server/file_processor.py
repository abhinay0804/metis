...
from server.extractors.ppt_extractor import PPTExtractor
from server.extractors.excel_extractor import ExcelExtractor
from server.extractors.image_extractor import ImageExtractor
from server.extractors.docx_extractor import DOCXExtractor
...
class FileProcessor:
    ...
    def __init__(self, use_model_detector: bool = False, ner_model: str = None, enable_logo_redaction: bool = True, enable_ocr: bool = True):
        self.extractors = {
            ...
            'image/jpeg': ImageExtractor(enable_logo_redaction=enable_logo_redaction, enable_ocr=enable_ocr, yolo_model_path=settings.YOLO_MODEL_PATH),
            'image/png': ImageExtractor(enable_logo_redaction=enable_logo_redaction, enable_ocr=enable_ocr, yolo_model_path=settings.YOLO_MODEL_PATH),
            'image/jpg': ImageExtractor(enable_logo_redaction=enable_logo_redaction, enable_ocr=enable_ocr, yolo_model_path=settings.YOLO_MODEL_PATH),
