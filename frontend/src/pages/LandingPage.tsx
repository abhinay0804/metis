...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Secure Data Platform</p>
            </div>
          </div>
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-background via-muted/50 to-primary/10 py-20">
      ...
      <section id="contact" className="py-20 bg-background">
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Have questions about our enterprise security platform or need a custom plan? Our team is here to help.
            </p>
            <div className="flex justify-center gap-6 mt-10">
              <a href="mailto:namaabhinay@gmail.com">
                <Button size="lg" className="rounded-full h-14 w-14 p-0 shadow-medium hover:shadow-large transition-all">
                  <Mail className="h-6 w-6" />
                  <span className="sr-only">Email Us</span>
                </Button>
              </a>
              <a href="https://github.com/abhinay0804/metis" target="_blank" rel="noreferrer">
                <Button size="lg" className="rounded-full h-14 w-14 p-0 shadow-medium hover:shadow-large transition-all">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="container text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of organizations protecting their sensitive data with Metis. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <div>
                  <h3 className="font-bold">Metis</h3>
                  <p className="text-xs text-muted-foreground">Secure Data Platform</p>
                </div>
              </div>
